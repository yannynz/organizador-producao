...
public class AmqpConfig {
  @Bean TopicExchange opExchange() { return new TopicExchange("op.exchange", true, false); }
  @Bean Queue opImportedQueue()    { return new Queue("op.imported", true); }
  @Bean Binding binding(Queue opImportedQueue, TopicExchange opExchange) {
