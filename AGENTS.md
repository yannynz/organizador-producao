...
- Imagens DXF no front vêm de `/api/dxf-analysis/order/{nr}`:
  ...
  - `DXFAnalysisService.findLatestByOrderNr` retorna a análise mais recente **com imagem válida** quando disponível; cai para o último registro se não houver imagem.
